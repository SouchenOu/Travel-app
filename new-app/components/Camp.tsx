...
const Site = ({backgroundImage, title, subtitle, peopleJoined} : Element) =>{
    return (
        <div className={`h-full w-full min-w-[1100px] bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl ${backgroundImage}` }   style={{backgroundImage: `url(${backgroundImage})`}}
        >
...
const Camp = () => {
  return (
    <section className='border-2 border-green-300 px-[20px]  2xl:mx-auto 2xl:max-w-[1440px] flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20 relative'>
        <div className='hide-scrollbar flex h-full w-full items-start justify-start gap-8 overflow-x-auto lg:h-[600px] xl:4-[640px]'>
        ...
        <div className='flex items-center justify-end mt-10 px-6 lg:-mt-60 lg:mr-6'>
            <div className=' p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 w-full overflow-hidden rounded-3xl' style={{background : '#013328'}}>
